...
impl fmt::Display for Entity {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            Entity::V(value) => write!(f, "inlined value"),
            ...
            Entity::ExternClosure(fid, funcid, params) => write!(f, "external closure"),
            Entity::LocalClosure(rbuf, captured_values) => write!(f, "local closure"),
            Entity::Group(tbuf) => write!(f, "group"),
            Entity::Operation(left_right, op) => write!(f, "{}", op.to_string()),
